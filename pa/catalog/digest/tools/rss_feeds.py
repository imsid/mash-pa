...
class SubscribeRssFeedTool(_BaseTool):
    ...
    description = (
        ...
        "once to a canonical feed (Apple Podcasts for podcasts, YouTube Data API "
        "for creators) and cached; "
...
class FetchRssItemsTool(_BaseTool):
    ...
    description = (
        ...
        "RSS URL for podcast). Resolves the feed (Apple Podcasts / YouTube Data "
        "API) and returns up to `max_items` newest items with "
